#!/usr/bin/env python3
"""Build stage 2: verified coral O, white CTO, and white G."""
...
BUILD = ROOT / "build"
ROM = BUILD / "octo-game-title-stage2-8k.a26"
...
def main() -> int:
    ...
    subprocess.run(["python3", "scripts/generate_title_stage2_data.py"], cwd=ROOT, check=True)
    bank0 = BUILD / "title-stage2-bank0.bin"
    bank1 = BUILD / "title-stage2-bank1.bin"
    assemble("src/title_stage1_bank0.asm", bank0, "TITLE_STAGE2=1")
    assemble(
        "src/main.asm",
        bank1,
